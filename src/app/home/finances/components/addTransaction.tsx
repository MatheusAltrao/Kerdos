          ...
          >
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Aqui voce irá cadastrar uma nova transação, informe todos os
                  campos.
                </p>
              </div>
                ...
                <div className="w-full space-y-1">
                  ...
                  <div className="space-y-1">
                    ...
                    {errors.transactionType && (
                      <p className="text-error">Tipo obrigatório</p>
                    )}
                  </div>
                </div>
                <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    ...
                    {errors.category && (
                      <p className="text-error">Categoria obrigatório</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    ...
                    {errors.bank && (
                      <p className="text-error">Banco obrigatório</p>
                    )}
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <DialogClose className="w-full" type="submit">
                <div className="flex h-9 w-full items-center justify-center gap-2 rounded-md bg-green-700 px-4 text-sm font-medium text-zinc-50 transition-colors hover:bg-green-800 ">
                  Criar <Plus size={16} />{" "}
                </div>
              </DialogClose>
            </div>
